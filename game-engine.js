...
(function() {
    ...
    const RHYTHM_FLASHCARDS = {
        lvl1: [
            ...
            { code: 'FC-07', title: '🍊 O-RANGE (Móc kép + Móc đơn chấm chung beam)', desc: '1 nốt móc kép ở đầu (1/4 phách) + 1 nốt móc đơn chấm dôi phía sau (3/4 phách) dính chùm chung vạch xà ngang (beam).', countText: 'Đếm: "1 e..."', notation: 'Móc kép + Móc đơn chấm dôi (chung beam)', abc: 'X:1\nM:1/4\nL:1/16\nK:C clef=perc\ncc3 |', soundType: 'pattern_orange', icon: '🍊' }
        ],
        lvl2: [
            { code: 'FC-08', title: '🫐 BLUE-BER-RY (1 móc đơn + 2 móc kép chung beam)', desc: '1 nốt móc đơn ở đầu (1/2 phách) + 2 nốt móc kép nối đằng sau (1/4 + 1/4) dính chùm chung beam.', countText: 'Đếm: "1 & a"', notation: '1 móc đơn + 2 móc kép chung beam', abc: 'X:1\nM:1/4\nL:1/16\nK:C clef=perc\nc2cc |', soundType: 'pattern_blueberry', icon: '🫐' },
            { code: 'FC-09', title: '🥥 CO-CO-NUT (2 móc kép + 1 móc đơn chung beam)', desc: '2 nốt móc kép ở đầu (1/4 + 1/4) + 1 nốt móc đơn nối đằng sau (1/2) dính chùm chung beam.', countText: 'Đếm: "1 e &"', notation: '2 móc kép + 1 móc đơn chung beam', abc: 'X:1\nM:1/4\nL:1/16\nK:C clef=perc\nccc2 |', soundType: 'pattern_coconut', icon: '🥥' },
            { code: 'FC-10', title: '🥒 CU-CUM-BER (1 móc kép - 1 móc đơn - 1 móc kép chung beam)', desc: 'Tiết tấu đảo phách dính chùm chung beam: 1 móc kép (1/4) + 1 móc đơn ở giữa (1/2) + 1 móc kép (1/4).', countText: 'Đếm: "1 e a"', notation: 'Móc kép - Móc đơn - Móc kép (chung beam)', abc: 'X:1\nM:1/4\nL:1/16\nK:C clef=perc\ncc2c |', soundType: 'pattern_cucumber', icon: '🥒' },
            { code: 'FC-11', title: '🫚 GIN-GER (2 phách: Đen chấm + Móc đơn chung beam)', desc: 'Nốt đen chấm dôi ngân dài 1.5 phách + nốt móc đơn nảy 0.5 phách ở cuối phách 2 dính chùm chung beam.', countText: 'Đếm: "1 . 2 &"', notation: '♩. 🎵 (Đen chấm + Móc đơn)', abc: 'X:1\nM:2/4\nL:1/8\nK:C clef=perc\nc3c |', soundType: 'pattern_ginger', icon: '🫚' },
            { code: 'FC-12', title: '🥕 CA-RROT (2 phách: Móc đơn + Đen chấm chung beam)', desc: 'Nốt móc đơn nảy 0.5 phách ở đầu + nốt đen chấm dôi ngân 1.5 phách vắt qua phách 2 dính chùm chung beam.', countText: 'Đếm: "1 & 2 ."', notation: '🎵 ♩. (Móc đơn + Đen chấm)', abc: 'X:1\nM:2/4\nL:1/8\nK:C clef=perc\ncc3 |', soundType: 'pattern_carrot', icon: '🥕' },
        ...
        lvl3: [
            { code: 'FC-17', title: '🍌 BA-NA-NA / PINE-AP-PLE (Chùm 3 Liên ba 1 phách)', desc: 'Chùm 3 nốt liên ba (Triplet) chia 1 phách làm 3 phần đều nhau hoàn hảo dính chùm chung beam.', countText: 'Đếm: "1-2-3 / 1-thị-trưởng"', notation: 'Chùm 3 Liên Ba 1 phách', abc: 'X:1\nM:1/4\nL:1/8\nK:C clef=perc\n(3ccc |', soundType: 'pattern_triplet', icon: '🍌' },
            { code: 'FC-18', title: '🥑 A-VO-CA-DO (Chùm 3 móc kép + 1 móc đơn chung beam)', desc: '3 nốt móc kép chạy dồn dập ở đầu + 1 nốt móc đơn lót phía sau dính chùm chung beam.', countText: 'Đếm: "1 e & - a"', notation: '3 móc kép + 1 móc đơn (chung beam)', abc: 'X:1\nM:1/4\nL:1/16\nK:C clef=perc\ncccc2 |', soundType: 'pattern_avocado', icon: '🥑' },
            { code: 'FC-19', title: '🍠 SWEET-PO-TA-TO (1 móc đơn + Chùm 3 móc kép chung beam)', desc: '1 nốt móc đơn đứng ở đầu + 3 nốt móc kép dồn dập lót phía sau dính chùm chung beam.', countText: 'Đếm: "1 - e & a"', notation: '1 móc đơn + 3 móc kép (chung beam)', abc: 'X:1\nM:1/4\nL:1/16\nK:C clef=perc\nc2ccc |', soundType: 'pattern_potato', icon: '🍠' },
