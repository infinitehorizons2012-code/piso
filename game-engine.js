...
(function() {
    ...
    const RHYTHM_FLASHCARDS = {
        ...
        lvl2: [
            ...
            { code: 'FC-09', title: '🥥 CO-CO-NUT (2 móc kép + 1 móc đơn dính chùm 1 beam)', desc: '2 nốt móc kép (1/4 + 1/4) + 1 nốt móc đơn (1/2) dính chùm chung 1 vạch xà ngang chính (beam) nối liền cả 3 nốt.', countText: 'Đếm: "1 e &"', notation: '2 móc kép + 1 móc đơn (dính chùm 1 beam)', abc: 'X:1\nM:1/4\nL:1/8\nK:C clef=perc\nc/2c/2c |', soundType: 'pattern_coconut', icon: '🥥' },
            { code: 'FC-10', title: '🥒 CU-CUM-BER (Móc kép - Móc đơn - Móc kép dính chùm 1 beam)', desc: 'Tiết tấu đảo phách: 1 móc kép (1/4) + 1 móc đơn ở giữa (1/2) + 1 móc kép (1/4) dính chùm chung 1 vạch xà ngang chính (beam) nối liền cả 3 nốt.', countText: 'Đếm: "1 e a"', notation: 'Móc kép - Móc đơn - Móc kép (dính chùm 1 beam)', abc: 'X:1\nM:1/4\nL:1/8\nK:C clef=perc\nc/2cc/2 |', soundType: 'pattern_cucumber', icon: '🥒' },
            { code: 'FC-11', title: '🫚 GIN-GER (2 phách: Đen chấm + Móc đơn dính chùm)', desc: 'Nốt đen chấm dôi ngân dài 1.5 phách + nốt móc đơn nảy 0.5 phách ở cuối phách 2.', countText: 'Đếm: "1 . 2 &"', notation: '♩. 🎵 (2 phách)', abc: 'X:1\nM:2/4\nL:1/8\nK:C clef=perc\nc3c |', soundType: 'pattern_ginger', icon: '🫚' },
            { code: 'FC-12', title: '🥕 CA-RROT (2 phách: Móc đơn + Đen chấm dính chùm)', desc: 'Nốt móc đơn nảy 0.5 phách ở đầu + nốt đen chấm dôi ngân 1.5 phách vắt qua phách 2.', countText: 'Đếm: "1 & 2 ."', notation: '🎵 ♩. (2 phách)', abc: 'X:1\nM:2/4\nL:1/8\nK:C clef=perc\ncc3 |', soundType: 'pattern_carrot', icon: '🥕' },
